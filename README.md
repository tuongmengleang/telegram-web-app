...
🌏 Starter using Vite 7 + Vue 3.x + Pinia 3.x + TypeScript + i18n + TailwindCSS 4.x + Unplugin + ESLint v9 to fast build a prototyping

ស៊ុមគំរូគម្រោងស្រេចជាស្រាប់ សម្រាប់អភិវឌ្ឍន៍ប្រព័ន្ធគ្រប់គ្រងខាងក្រោយទំហំតូច និងមធ្យម ដោយប្រើ Vue3 + Vite6 + TS + Pinia 🚀🚀🚀 ដែលមានលក្ខណៈអាចពង្រីកអន្តរជាតិនិងពហុភាសា (i18n) និងជួយឱ្យអ្នកអភិវឌ្ឍបានរហ័ស។ វាត្រូវបានរួមបញ្ចូលជាមួយ vue-i18n-next 💪
